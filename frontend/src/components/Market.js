            ...
            <div className="col-span-12 sm:col-span-6 lg:col-span-4 bg-gray-600 text-white relative robot-card" key={item.name}>
                ...
                <div className="p-6 ">
                    ...
                    <div className="flex justify-between items-center my-4">
                        ...
                        {item.stock === 0 ? '' : 
                             <button className='justify-self-center flex justify-center items-center text-center p-6 bg-red-500 hover:bg-red-700 rounded w-3/4 h-12' onClick={() => onAdd(robots)}>
